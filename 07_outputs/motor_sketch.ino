...
const int BACK_RIGHT_PIN1 = D4;
const int BACK_RIGHT_PIN2 = D3;
...
const int TURN_INNER_SPEED = 120; // Inner wheels during turn - slower
...
void turnLeft() {
  ...
  setMotor(FRONT_LEFT_PIN1, FRONT_LEFT_PIN2, TURN_INNER_SPEED, true);
  setMotor(BACK_LEFT_PIN1, BACK_LEFT_PIN2, TURN_INNER_SPEED, true);
...
void turnRight() {
  ...
  setMotor(FRONT_RIGHT_PIN1, FRONT_RIGHT_PIN2, TURN_INNER_SPEED, true);
  setMotor(BACK_RIGHT_PIN1, BACK_RIGHT_PIN2, TURN_INNER_SPEED, true);
}
